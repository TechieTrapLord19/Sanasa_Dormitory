...
<div class="sales-header d-flex justify-content-between align-items-center">
    ...
    <a href="<?php echo e(route('sales.consolidated', ['start_date' => $startDate, 'end_date' => $endDate])); ?>" class="btn-consolidated">
...
<div class="sales-filters">
    <form id="salesFilterForm" action="<?php echo e(route('sales.index')); ?>" method="GET">
        <div class="filter-row">
            <div class="filter-group">
                <label class="filter-label">Start Date</label>
                <input type="date" name="start_date" class="filter-input" value="<?php echo e($startDate); ?>" required>
            </div>
            <div class="filter-group">
                <label class="filter-label">End Date</label>
                <input type="date" name="end_date" class="filter-input" value="<?php echo e($endDate); ?>" required>
            </div>
...
<div class="row stats-row">
    <div class="col-md-4 mb-3 mb-md-0">
        <div class="stat-card sales">
            ...
            <h6>Total Revenue</h6>
            <p class="stat-value">₱<?php echo e(number_format($totalSales, 2)); ?></p>
        </div>
    </div>
    <div class="col-md-4 mb-3 mb-md-0">
        <div class="stat-card transactions">
            ...
            <p class="stat-value"><?php echo e(number_format($totalTransactions)); ?></p>
        </div>
    </div>
    <div class="col-md-4">
        <div class="stat-card outstanding">
            ...
            <p class="stat-value">₱<?php echo e(number_format($outstandingBalance, 2)); ?></p>
        </div>
    </div>
</div>
...
<div class="charts-section">
    ...
    <div class="chart-card">
        ...
        <div class="chart-container">
            <?php if(count($dailyIncomeChart['data']) > 0): ?>
    ...
    <div class="chart-card">
        ...
        <div class="chart-container doughnut">
            <?php if(array_sum($paymentTypeChart['data']) > 0): ?>
...
<div class="sales-table-container">
    <table class="sales-table">
        <thead>
            <tr>
                <th class="sortable <?php echo e($sortBy === 'date_received' ? 'active' : ''); ?>" onclick="sortTable('date_received')">
                    Date
                    <?php if($sortBy === 'date_received'): ?>
                ...
                <th>Tenant(s)</th>
                <th>Room</th>
                <th class="sortable <?php echo e($sortBy === 'payment_type' ? 'active' : ''); ?>" onclick="sortTable('payment_type')">
                    Payment Type
                    <?php if($sortBy === 'payment_type'): ?>
                        <i class="bi bi-<?php echo e($sortDir === 'asc' ? 'sort-up' : 'sort-down'); ?> sort-icon"></i>
                    <?php else: ?>
                        <i class="bi bi-arrow-down-up sort-icon"></i>
                    <?php endif; ?>
                </th>
                <th class="sortable <?php echo e($sortBy === 'payment_method' ? 'active' : ''); ?>" onclick="sortTable('payment_method')">
                    Method
                ...
                <th class="sortable <?php echo e($sortBy === 'amount' ? 'active' : ''); ?>" onclick="sortTable('amount')">
                    Amount
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr>
                    <td>
                        <strong><?php echo e($payment->date_received->format('M d, Y')); ?></strong>
                        <br><small class="text-muted"><?php echo e($payment->created_at->format('g:i A')); ?></small>
                    </td>
                    <td>
                        <?php if($payment->booking_id): ?>
                            <a href="<?php echo e(route('bookings.show', $payment->booking_id)); ?>" style="color: #03255b; font-weight: 600;">
                    ...
                    <td>
                        <?php if($payment->invoice && $payment->invoice->booking): ?>
                            <?php echo e($payment->invoice->booking->tenant_summary); ?>
                    ...
                    <td>
                        <?php if($payment->invoice && $payment->invoice->booking && $payment->invoice->booking->room): ?>
                            <?php echo e($payment->invoice->booking->room->room_num); ?>
                    ...
                    <td>
                        <span class="payment-method-badge <?php echo e($methodClass); ?>">
                            ...
                            <?php endif; ?>
                            <?php echo e($payment->payment_method ?? 'N/A'); ?>

                        </span>
                    </td>
                    <td style="font-weight: 700; color: #059669;">₱<?php echo e(number_format($payment->amount, 2)); ?></td>
                    <td>
                        <?php if($payment->collectedBy): ?>
                            <?php echo e($payment->collectedBy->full_name); ?>
...
<div class="pagination-wrapper">
    <div class="pagination-left">
        <form method="GET" action="<?php echo e(route('sales.index')); ?>" class="d-flex align-items-center gap-2">
    ...
    <div class="pagination-center">
        <p class="small text-muted mb-0">
            Showing
            <span class="fw-semibold"><?php echo e($payments->firstItem() ?? 0); ?></span>
            to
            <span class="fw-semibold"><?php echo e($payments->lastItem() ?? 0); ?></span>
            of
            <span class="fw-semibold"><?php echo e($payments->total()); ?></span>
            results
        </p>
    </div>
    <div class="pagination-right">
        <?php echo e($payments->appends(['start_date' => $startDate, 'end_date' => $endDate, 'per_page' => $perPage, 'sort_by' => $sortBy, 'sort_dir' => $sortDir])->links()); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (incomeChartCanvas) {
        const incomeData = <?php echo json_encode($dailyIncomeChart, 15, 512) ?>;
    ...
    if (paymentTypeCanvas) {
        const paymentTypeData = <?php echo json_encode($paymentTypeChart, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hmmth\sanasa_dormitory\resources\views/contents/sales-index.blade.php ENDPATH**/ ?>