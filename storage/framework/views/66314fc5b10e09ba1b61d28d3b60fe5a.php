...
<body>
    <div class="error-card">
        ...
        <h2 class="mt-2 mb-3">Access Forbidden</h2>
        <p class="text-muted mb-4"><?php echo e($exception->getMessage() ?: 'You do not have permission to access this resource.'); ?></p>
        <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary px-4">
            <i class="bi bi-house-door me-1"></i> Back to Dashboard
        </a>
    </div>
</body>
</html>
<?php /**PATH C:\Users\hmmth\sanasa_dormitory\resources\views/errors/403.blade.php ENDPATH**/ ?>