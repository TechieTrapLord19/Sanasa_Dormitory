...
<div class="booking-form-container">
    ...
    <?php if(session('error')): ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong><i class="bi bi-exclamation-triangle"></i> Error:</strong> <?php echo e(session('error')); ?>
    ...
    <?php if(session('success')): ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong><i class="bi bi-check-circle"></i> Success:</strong> <?php echo e(session('success')); ?>
    ...
    <form id="bookingForm" action="<?php echo e(route('bookings.store')); ?>" method="POST" novalidate>
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               name="checkin_date"
                               id="checkin_date"
                               value="<?php echo e(old('checkin_date', date('Y-m-d'))); ?>"
                               required
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               value=""
                               readonly>
                        <input type="hidden" name="checkout_date" id="checkout_date" value="<?php echo e(old('checkout_date')); ?>">
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <input type="hidden" name="stay_length" id="stay_length" value="<?php echo e(old('stay_length')); ?>" required>
            ...
            <div class="form-group">
                ...
                <div id="roomsContainer" class="rooms-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="room-card"
                             data-room-id="<?php echo e($room->room_id); ?>"
                             data-capacity="<?php echo e($room->capacity); ?>"
                             data-status="<?php echo e($room->status); ?>"
                             onclick="selectRoom(<?php echo e($room->room_id); ?>)">
                            <div class="room-number"><?php echo e($room->room_num); ?></div>
                            <div class="room-floor">Floor <?php echo e($room->floor); ?> • Capacity: <?php echo e($room->capacity); ?></div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <p class="text-muted">No available rooms at the moment.</p>
                    <?php endif; ?>
                </div>
            <input type="hidden" name="room_id" id="selected_room_id" value="<?php echo e(old('room_id', $selectedRoomId ?? '')); ?>" required>                <?php $__errorArgs = ['room_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div id="tenantListContainer" class="tenant-list-container">
                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = $tenants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tenant-dropdown-item" data-tenant-name="<?php echo e(strtolower($tenant->full_name)); ?>">
                                        <input type="checkbox"
                                               class="tenant-checkbox"
                                               name="tenant_ids[]"
                                               value="<?php echo e($tenant->tenant_id); ?>"
                                               id="tenant_<?php echo e($tenant->tenant_id); ?>"
                                               <?php echo e(in_array($tenant->tenant_id, old('tenant_ids', [])) ? 'checked' : ''); ?>>
                                        <label for="tenant_<?php echo e($tenant->tenant_id); ?>" class="tenant-label">
...
unset($__errorArgs, $__bag); ?>
            ...
            <input type="hidden" name="rate_id" id="rate_id" value="<?php echo e(old('rate_id')); ?>" required>
        </div>
...
function checkAvailability() {
    ...
    fetch(`<?php echo e(route('bookings.check-availability')); ?>?checkin_date=${checkin}&checkout_date=${checkout}`)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php if($errors->any() || old('room_id') || old('stay_length')): ?>
        console.log('Restoring form state from old input...');

        // Restore selected room
        const oldRoomId = '<?php echo e(old('room_id')); ?>';
        if (oldRoomId) {
        ...
        const oldStayLength = '<?php echo e(old('stay_length')); ?>';
        if (oldStayLength) {
        ...
        <?php if($errors->has('room_id') || $errors->has('checkin_date') || $errors->has('stay_length')): ?>
            // Stay on step 1
            console.log('Errors in step 1, staying on step 1');
        <?php elseif($errors->has('tenant_ids') || $errors->has('rate_id')): ?>
            // Move to step 2
    ...
    tenantForm.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch('<?php echo e(route('tenants.store')); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hmmth\sanasa_dormitory\resources\views/contents/bookings-create.blade.php ENDPATH**/ ?>