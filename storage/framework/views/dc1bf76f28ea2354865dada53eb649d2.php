<?php $__env->startSection('title', 'Security Deposit Details'); ?>
...
<div class="deposit-header">
    <h1 class="deposit-title">
        ...
        Security Deposit #<?php echo e($securityDeposit->security_deposit_id); ?>

    </h1>
    <a href="<?php echo e(route('security-deposits.index')); ?>" class="btn-back">
...
<?php if(session('success')): ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            showToast('<?php echo e(session('success')); ?>', 'success', 4000);
        });
    </script>
<?php endif; ?>
...
<?php if(session('error')): ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            showToast('<?php echo e(session('error')); ?>', 'error', 5000);
        });
    </script>
<?php endif; ?>
...
<div class="deposit-grid">
    ...
    <div class="deposit-main">
        ...
        <div class="deposit-card">
            <div class="card-header">
                ...
                ?>
                <span class="status-badge-large <?php echo e($statusClass); ?>"><?php echo e($securityDeposit->status); ?></span>
            </div>
            <div class="card-body">
                <div class="amount-grid">
                    <div class="amount-item">
                        <div class="label">Required</div>
                        <div class="value">₱<?php echo e(number_format($securityDeposit->amount_required, 2)); ?></div>
                    </div>
                    <div class="amount-item">
                        <div class="label">Paid</div>
                        <div class="value">₱<?php echo e(number_format($securityDeposit->amount_paid, 2)); ?></div>
                    </div>
                    <div class="amount-item deducted">
                        <div class="label">Deducted</div>
                        <div class="value">-₱<?php echo e(number_format($securityDeposit->amount_deducted, 2)); ?></div>
                    </div>
                    <div class="amount-item highlight">
                        <div class="label">Refundable Balance</div>
                        <div class="value">₱<?php echo e(number_format($securityDeposit->calculateRefundable(), 2)); ?></div>
                    </div>
                </div>

                <?php if($securityDeposit->amount_refunded > 0): ?>
                    <div class="mt-3 p-3 bg-light rounded">
                        <small class="text-muted">Amount Refunded: </small>
                        <strong class="text-success">₱<?php echo e(number_format($securityDeposit->amount_refunded, 2)); ?></strong>
                        <?php if($securityDeposit->refunded_at): ?>
                            <small class="text-muted ms-2">on <?php echo e($securityDeposit->refunded_at->format('M d, Y h:i A')); ?></small>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="card-body">
                <table class="info-table">
                    <tr>
                        <td>Booking ID</td>
                        <td>
                            <a href="<?php echo e(route('bookings.show', $securityDeposit->booking_id)); ?>" style="color: #03255b; font-weight: 600;">
                                #<?php echo e($securityDeposit->booking_id); ?>
                    ...
                    <tr>
                        <td>Tenant</td>
                        <td>
                            <strong><?php echo e($securityDeposit->booking->tenant->first_name ?? 'N/A'); ?> <?php echo e($securityDeposit->booking->tenant->last_name ?? ''); ?></strong>
                            <?php if($securityDeposit->booking->secondaryTenant): ?>
                                <br><small class="text-muted">& <?php echo e($securityDeposit->booking->secondaryTenant->first_name); ?> <?php echo e($securityDeposit->booking->secondaryTenant->last_name); ?></small>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>Room</td>
                        <td>Room <?php echo e($securityDeposit->booking->room->room_number ?? 'N/A'); ?></td>
                    </tr>
                    <tr>
                        <td>Check-in</td>
                        <td>
                            <?php echo e($securityDeposit->booking->checkin_date?->format('M d, Y') ?? 'N/A'); ?>

                            <?php if($securityDeposit->booking->checked_in_at): ?>
                                <small class="text-success">(<?php echo e($securityDeposit->booking->checked_in_at->format('g:i A')); ?>)</small>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>Check-out</td>
                        <td>
                            <?php echo e($securityDeposit->booking->checkout_date?->format('M d, Y') ?? 'N/A'); ?>

                            <?php if($securityDeposit->booking->checked_out_at): ?>
                                <small class="text-success">(<?php echo e($securityDeposit->booking->checked_out_at->format('g:i A')); ?>)</small>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-<?php echo e($securityDeposit->booking->status === 'Active' ? 'success' : ($securityDeposit->booking->status === 'Completed' ? 'secondary' : 'warning')); ?>">
                                <?php echo e($securityDeposit->booking->status); ?>
        ...
        <div class="deposit-card">
            ...
            <div class="card-body">
                <?php $deductions = $securityDeposit->getDeductionsArray(); ?>
                        ...
                        <?php $__currentLoopData = $deductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="deduction-item">
                                <div class="deduction-info">
                                    <div class="deduction-category"><?php echo e($deduction['category']); ?></div>
                                    <?php if(!empty($deduction['description'])): ?>
                                        <div class="deduction-desc"><?php echo e($deduction['description']); ?></div>
                                    <?php endif; ?>
                                    <div class="deduction-date"><?php echo e(\Carbon\Carbon::parse($deduction['date'])->format('M d, Y h:i A')); ?></div>
                                </div>
                                <div class="deduction-amount">-₱<?php echo e(number_format($deduction['amount'], 2)); ?></div>
                            </div>
    ...
    <div class="deposit-sidebar">
            ...
            <div class="card-body">
                ...
                <div class="action-buttons">
                    <button type="button" class="btn-action btn-deduct"
                            ...
                            <?php echo e($isClosed || !$hasRefundable ? 'disabled' : ''); ?>>
        ...
        <!-- Notes Card -->
        <?php if($securityDeposit->notes): ?>
            <div class="deposit-card">
                <div class="card-header">
                    <h3><i class="bi bi-sticky"></i> Notes</h3>
                </div>
                <div class="card-body">
                    <p style="white-space: pre-wrap; margin: 0; font-size: 0.875rem; color: #475569;"><?php echo e($securityDeposit->notes); ?></p>
                </div>
            </div>
        <?php endif; ?>

        <!-- Processed By Card -->
        <?php if($securityDeposit->processedBy): ?>
            <div class="deposit-card">
                <div class="card-header">
                ...
                <div class="card-body">
                    <p style="margin: 0; font-size: 0.875rem;">
                        <?php echo e($securityDeposit->processedBy->name); ?>

                        <?php if($securityDeposit->refunded_at): ?>
                            <br><small class="text-muted"><?php echo e($securityDeposit->refunded_at->format('M d, Y h:i A')); ?></small>
                        <?php endif; ?>
                    </p>
                </div>
            </div>
...
<div class="modal fade" id="deductionModal" tabindex="-1" aria-labelledby="deductionModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo e(route('security-deposits.deduction', $securityDeposit)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select name="category" id="deductionCategory" class="form-select" required>
                            ...
                            <?php $__currentLoopData = \App\Models\SecurityDeposit::getDeductionCategories(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="mb-3" id="invoiceSelectionGroup" style="display: none;">
                        ...
                        <select name="invoice_id" id="invoiceSelect" class="form-select">
                            ...
                            <?php if(isset($outstandingInvoices) && $outstandingInvoices->count() > 0): ?>
                                <?php $__currentLoopData = $outstandingInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($invoice->invoice_id); ?>" data-balance="<?php echo e($invoice->remaining_balance); ?>">
                                        Invoice #<?php echo e($invoice->invoice_id); ?> - <?php echo e($invoice->date_generated->format('M Y')); ?>

                                        (Balance: ₱<?php echo e(number_format($invoice->remaining_balance, 2)); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="amount" id="deductionAmount" class="form-control"
                                   step="0.01" min="0.01" max="<?php echo e($securityDeposit->calculateRefundable()); ?>" required>
                        </div>
                        <small class="text-muted">Maximum: ₱<?php echo e(number_format($securityDeposit->calculateRefundable(), 2)); ?></small>
                    </div>
                    <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    invoiceSelect.addEventListener('change', function() {
        ...
        if (selectedOption && selectedOption.dataset.balance) {
            ...
            const maxDeduction = <?php echo e($securityDeposit->calculateRefundable()); ?>;
...
<div class="modal fade" id="refundModal" tabindex="-1" aria-labelledby="refundModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo e(route('security-deposits.refund', $securityDeposit)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="alert alert-info mb-3">
                        <i class="bi bi-info-circle me-2"></i>
                        Refundable amount: <strong>₱<?php echo e(number_format($securityDeposit->calculateRefundable(), 2)); ?></strong>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="refund_amount" class="form-control"
                                   step="0.01" min="0" max="<?php echo e($securityDeposit->calculateRefundable()); ?>"
                                   value="<?php echo e($securityDeposit->calculateRefundable()); ?>" required>
                        </div>
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="forfeitModal" tabindex="-1" aria-labelledby="forfeitModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo e(route('security-deposits.forfeit', $securityDeposit)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="alert alert-danger">
                        ...
                        <strong>₱<?php echo e(number_format($securityDeposit->calculateRefundable(), 2)); ?></strong>.
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hmmth\sanasa_dormitory\resources\views/contents/security-deposit-show.blade.php ENDPATH**/ ?>