...
<div class="container-fluid py-4">
    ...
    <div class="fs-header d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(route('financial-statement.export', ['date_filter' => $dateFilter])); ?>" class="btn btn-outline-secondary">
            <i class="bi bi-file-pdf"></i> PDF
        </a>
    </div>

    <!-- Date Filter -->
    <form method="GET" action="<?php echo e(route('financial-statement')); ?>" class="filters-card">
        <div class="filter-group">
            ...
            <select name="date_filter" class="filter-select" onchange="this.form.submit()">
                ...
                <option value="this_quarter" <?php echo e($dateFilter == 'this_quarter' ? 'selected' : ''); ?>>This Quarter</option>
            ...
            <?php if($dateFrom && $dateTo): ?>
                <span class="text-muted ms-2"><?php echo e(\Carbon\Carbon::parse($dateFrom)->format('M d, Y')); ?> - <?php echo e(\Carbon\Carbon::parse($dateTo)->format('M d, Y')); ?></span>
            <?php endif; ?>
        </div>
    </form>
    ...
    <div class="summary-grid">
        <div class="summary-card revenue">
            ...
            <div class="summary-value">₱<?php echo e(number_format($totalRevenue, 2)); ?></div>
        </div>
        <div class="summary-card expense">
            <div class="summary-label"><i class="bi bi-graph-down-arrow"></i> Total Expenses</div>
            <div class="summary-value">₱<?php echo e(number_format($totalExpensesAndRefunds, 2)); ?></div>
        </div>
        <div class="summary-card net <?php echo e($netIncome >= 0 ? 'positive' : 'negative'); ?>">
            <div class="summary-label"><i class="bi bi-cash-stack"></i> Net Income</div>
            <div class="summary-value"><?php echo e($netIncome >= 0 ? '' : '-'); ?>₱<?php echo e(number_format(abs($netIncome), 2)); ?></div>
        </div>
        <div class="summary-card liability">
            <div class="summary-label"><i class="bi bi-shield-check"></i> Security Deposits Held</div>
            <div class="summary-value">₱<?php echo e(number_format($securityDepositsHeld, 2)); ?></div>
        </div>
        <div class="summary-card outstanding">
            <div class="summary-label"><i class="bi bi-hourglass-split"></i> Outstanding Balance</div>
            <div class="summary-value">₱<?php echo e(number_format($outstandingBalance, 2)); ?></div>
        </div>
    </div>
    ...
    <div class="row-gap">
            ...
            <div class="section-card">
                ...
                <div class="section-body">
                    <table class="breakdown-table">
                        <tr>
                            <td>Rent Income</td>
                            <td class="amount-positive">₱<?php echo e(number_format($rentIncome, 2)); ?></td>
                        </tr>
                        <tr>
                            <td>Electricity Fees</td>
                            <td class="amount-positive">₱<?php echo e(number_format($electricityIncome, 2)); ?></td>
                        </tr>
                        <tr>
                            <td>Forfeited Deposits</td>
                            <td class="amount-positive">₱<?php echo e(number_format($forfeitedDeposits, 2)); ?></td>
                        </tr>
                        <tr class="total">
                            <td>Total Revenue</td>
                            <td class="amount-positive">₱<?php echo e(number_format($totalRevenue, 2)); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <div>
            <div class="section-card">
                ...
                <div class="section-body">
                    <table class="breakdown-table">
                        <?php $__currentLoopData = $expensesByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($category); ?></td>
                            <td class="amount-negative">₱<?php echo e(number_format($amount, 2)); ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="amount-negative">₱<?php echo e(number_format($totalRefunds, 2)); ?></td>
                        </tr>
                        <tr class="total">
                            <td>Total Expenses</td>
                            <td class="amount-negative">₱<?php echo e(number_format($totalExpensesAndRefunds, 2)); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    <div class="section-card">
        ...
        <div class="section-body">
            <div class="kpi-grid">
                <div class="kpi-card">
                    <div class="kpi-value"><?php echo e(number_format($collectionRate, 1)); ?>%</div>
                    <div class="kpi-label">Collection Rate</div>
                </div>
                <div class="kpi-card">
                    <div class="kpi-value"><?php echo e(number_format($occupancyRate, 1)); ?>%</div>
                    <div class="kpi-label">Occupancy Rate</div>
                </div>
                <div class="kpi-card">
                    <div class="kpi-value"><?php echo e($occupiedRooms); ?>/<?php echo e($totalRooms); ?></div>
                    <div class="kpi-label">Rooms Occupied</div>
                </div>
                <div class="kpi-card">
                    <div class="kpi-value">₱<?php echo e(number_format($totalCollected, 2)); ?></div>
            ...
            <div class="trends-chart">
                ...
                <div class="trend-bar-group">
                    <div class="trend-bars">
                        ...
                        ?>
                        <div class="trend-bar income" style="height: <?php echo e($incomeHeight); ?>%;" title="Income: ₱<?php echo e(number_format($trend['income'], 2)); ?>"></div>
                        <div class="trend-bar expense" style="height: <?php echo e($expenseHeight); ?>%;" title="Expenses: ₱<?php echo e(number_format($trend['expenses'], 2)); ?>"></div>
                    </div>
                    <div class="trend-label"><?php echo e(substr($trend['month'], 0, 3)); ?></div>
                    <div class="trend-net <?php echo e($trend['net'] >= 0 ? 'positive' : 'negative'); ?>">
                        <?php echo e($trend['net'] >= 0 ? '+' : ''); ?>₱<?php echo e(number_format(abs($trend['net']), 0)); ?>
    ...
    <div class="section-card">
        ...
        <div class="section-body p-0">
            <table class="receivables-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $receivables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e(optional(optional($invoice->booking)->tenant)->name ?? '—'); ?></td>
                        <td><?php echo e(optional(optional($invoice->booking)->room)->room_num ?? '—'); ?></td>
                        <td>#<?php echo e(str_pad($invoice->invoice_id, 5, '0', STR_PAD_LEFT)); ?></td>
                        <td>₱<?php echo e(number_format($invoice->total_due, 2)); ?></td>
                        <td>₱<?php echo e(number_format($invoice->paid ?? 0, 2)); ?></td>
                        <td class="amount-negative">₱<?php echo e(number_format($invoice->remaining_balance, 2)); ?></td>
                        <td>
                            <?php if($invoice->days_overdue > 0): ?>
                                <span class="badge-overdue"><?php echo e($invoice->days_overdue); ?> days</span>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hmmth\sanasa_dormitory\resources\views/contents/financial-statement.blade.php ENDPATH**/ ?>