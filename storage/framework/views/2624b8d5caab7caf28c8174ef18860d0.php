...
<div class="container-fluid py-4">
    ...
    <div class="summary-cards">
        <div class="summary-card">
            ...
            <div class="summary-card-value">₱<?php echo e(number_format($totalExpenses, 2)); ?></div>
        </div>
        <?php $__currentLoopData = $expensesByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat => $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="summary-card">
            <div class="summary-card-label"><?php echo e($cat); ?></div>
            <div class="summary-card-value">₱<?php echo e(number_format($total, 2)); ?></div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>

    <!-- Filters -->
    <form method="GET" action="<?php echo e(route('expenses.index')); ?>" class="expenses-filters">
        <div class="filter-group">
            ...
            <a href="<?php echo e(route('expenses.index')); ?>" class="filter-btn-clear ms-2">Clear</a>
        </div>
    </form>
    ...
    <div class="expenses-table-container">
        <table class="expenses-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo e($expense->category); ?><?php echo e($expense->asset_type ? ': ' . $expense->asset_type : ''); ?>

                    </td>
                    <td><?php echo e($expense->description ?? '—'); ?></td>
                    <td class="amount-col">₱<?php echo e(number_format($expense->amount, 2)); ?></td>
                    <td><?php echo e($expense->receipt_number ?? '—'); ?></td>
                    <td><?php echo e($expense->recordedBy->full_name ?? '—'); ?></td>
                    <td>
                        <button class="btn-action btn-edit" data-bs-toggle="modal" data-bs-target="#editExpenseModal"
                            data-id="<?php echo e($expense->expense_id); ?>"
                            data-category="<?php echo e($expense->category); ?>"
                            data-asset-type="<?php echo e($expense->asset_type); ?>"
                            data-description="<?php echo e($expense->description); ?>"
                            data-amount="<?php echo e($expense->amount); ?>"
                            data-date="<?php echo e($expense->expense_date->format('Y-m-d')); ?>"
                            data-receipt="<?php echo e($expense->receipt_number); ?>"
                            data-notes="<?php echo e($expense->notes); ?>">
        ...
        <div class="pagination-wrapper">
            <div>Showing <?php echo e($expenses->firstItem()); ?> to <?php echo e($expenses->lastItem()); ?> of <?php echo e($expenses->total()); ?> expenses</div>
...
<datalist id="assetNamesList">
    <?php $__currentLoopData = $assetNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assetName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($assetName); ?>">
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</datalist>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hmmth\sanasa_dormitory\resources\views/contents/expenses.blade.php ENDPATH**/ ?>