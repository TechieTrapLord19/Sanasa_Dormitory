                ...
                <div class="col-12">
                    <div class="form-check form-switch form-switch-custom">
                        <input class="form-check-input" type="checkbox" role="switch"
                               ...
                               value="1" <?php echo e($settings['auto_apply_penalties'] ? 'checked' : ''); ?>>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="late_penalty_type" id="late_penalty_type" class="form-select form-select-custom" required>
                        <option value="percentage" <?php echo e($settings['late_penalty_type'] == 'percentage' ? 'selected' : ''); ?>>Percentage of Total Due</option>
                        <option value="fixed" <?php echo e($settings['late_penalty_type'] == 'fixed' ? 'selected' : ''); ?>>Fixed Amount</option>
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" step="0.01" min="0" max="100"
                               ...
                               value="<?php echo e($settings['late_penalty_rate']); ?>" required>
                        <span class="input-group-text input-group-text-custom" id="penalty-rate-suffix">
                            <?php echo e($settings['late_penalty_type'] == 'percentage' ? '%' : 'P'); ?>

                        </span>
                    </div>
                    <div class="form-help-text">
                        <span id="rate-help-text">
                            <?php echo e($settings['late_penalty_type'] == 'percentage' ? 'Percentage to add to the total due.' : 'Fixed peso amount to add.'); ?>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" min="0" max="60"
                           ...
                           class="form-control form-control-custom"
                           value="<?php echo e($settings['late_penalty_grace_days']); ?>" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="late_penalty_frequency" id="late_penalty_frequency" class="form-select form-select-custom" required>
                        <option value="once" <?php echo e($settings['late_penalty_frequency'] == 'once' ? 'selected' : ''); ?>>One-Time (Applied Once)</option>
                        <option value="daily" <?php echo e($settings['late_penalty_frequency'] == 'daily' ? 'selected' : ''); ?>>Daily (Compounds Daily)</option>
                        <option value="weekly" <?php echo e($settings['late_penalty_frequency'] == 'weekly' ? 'selected' : ''); ?>>Weekly (Compounds Weekly)</option>
                        <option value="monthly" <?php echo e($settings['late_penalty_frequency'] == 'monthly' ? 'selected' : ''); ?>>Monthly (Compounds Monthly)</option>
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="1" max="60"
                               ...
                               class="form-control form-control-custom"
                               value="<?php echo e($settings['invoice_due_days']); ?>" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hmmth\sanasa_dormitory\resources\views/contents/settings-index.blade.php ENDPATH**/ ?>