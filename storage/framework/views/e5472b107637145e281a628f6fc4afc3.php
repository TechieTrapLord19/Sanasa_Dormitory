...
<div class="booking-form-container">
    ...
    <form id="editBookingForm" action="<?php echo e(route('bookings.update', $booking->booking_id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               name="checkin_date"
                               id="checkin_date"
                               value="<?php echo e(old('checkin_date', $booking->checkin_date->format('Y-m-d'))); ?>"
                               <?php if($booking->status === 'Active'): ?> readonly style="background-color: #f8f9fa;" <?php else: ?> required <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                        <?php if($booking->checked_in_at): ?>
                            <small class="text-success">Arrived: <?php echo e($booking->checked_in_at->format('M d, Y - g:i A')); ?></small>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               id="checkout_display"
                               readonly>
                        <input type="hidden" name="checkout_date" id="checkout_date" value="<?php echo e(old('checkout_date', $booking->checkout_date->format('Y-m-d'))); ?>">
                        <?php if($booking->checked_out_at): ?>
                            <small class="text-success">Left: <?php echo e($booking->checked_out_at->format('M d, Y - g:i A')); ?></small>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number"
                               ...
                               min="1"
                               class="form-control <?php $__errorArgs = ['stay_length'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                               ...
                               <?php if($booking->status === 'Active'): ?> readonly style="background-color: #f8f9fa;" <?php endif; ?>
                               value="<?php echo e(old('stay_length', $defaultStayLength)); ?>">
                        <input type="hidden" name="stay_length" id="stay_length" value="<?php echo e(old('stay_length', $defaultStayLength)); ?>" required>
                        <?php $__errorArgs = ['stay_length'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <div class="duration-presets">
                    <button type="button" class="duration-button" data-days="1" <?php echo e($booking->status === 'Active' ? 'disabled' : ''); ?>>1 Day</button>
                    <button type="button" class="duration-button" data-days="7" <?php echo e($booking->status === 'Active' ? 'disabled' : ''); ?>>7 Days</button>
                    <button type="button" class="duration-button" data-days="30" <?php echo e($booking->status === 'Active' ? 'disabled' : ''); ?>>30 Days</button>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="room_id" id="selected_room_id" value="<?php echo e(old('room_id', $booking->room_id)); ?>" required>
                    ...
                    <div class="tenant-dropdown-menu" id="tenantDropdownMenu">
                        <div class="tenant-list-container" id="tenantListContainer">
                            <?php $__currentLoopData = $tenants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <div class="tenant-dropdown-item <?php echo e($isCurrentTenant ? 'selected' : ''); ?>"
                                     data-debug="tenant_id=<?php echo e($tenant->tenant_id); ?>, booking_tenant=<?php echo e($booking->tenant_id); ?>, secondary=<?php echo e($booking->secondary_tenant_id); ?>, match=<?php echo e($isCurrentTenant ? 'yes' : 'no'); ?>">
                                    <input type="checkbox"
                                           class="tenant-checkbox"
                                           name="tenant_ids[]"
                                           value="<?php echo e($tenant->tenant_id); ?>"
                                           id="tenant_<?php echo e($tenant->tenant_id); ?>"
                                           data-name="<?php echo e($tenant->full_name); ?>"
                                           <?php echo e($isCurrentTenant ? 'checked' : ''); ?>>
                                    <label class="tenant-label" for="tenant_<?php echo e($tenant->tenant_id); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="info-box mt-3">
                <p><strong>Current Room:</strong> <?php echo e($booking->room->room_num); ?> (Floor <?php echo e($booking->room->floor); ?>)</p>
                <p id="rateInfoDisplay"><strong>Current Rate:</strong> <?php echo e($booking->rate->duration_type); ?> - ₱<?php echo e(number_format($booking->rate->base_price, 2)); ?></p>
                <p><strong>Status:</strong> <span style="color: #10b981; font-weight: 600;"><?php echo e($booking->status); ?></span></p>
            </div>
        ...
        <div class="step-content" data-step="3">
            ...
            <div class="summary-box">
                <div class="summary-row">
                    <span>Room:</span>
                    <span id="summary_room"><?php echo e($booking->room->room_num); ?></span>
                </div>
                <div class="summary-row">
                    <span>Tenant(s):</span>
                ...
                <div class="summary-row">
                    <span>Check-in:</span>
                    <span id="summary_checkin"><?php echo e($booking->checkin_date->format('M d, Y')); ?></span>
                </div>
                <div class="summary-row">
                    <span>Check-out:</span>
                    <span id="summary_checkout"><?php echo e($booking->checkout_date->format('M d, Y')); ?></span>
                </div>
                <div class="summary-row">
                    <span>Total Nights:</span>
                    <span id="summary_nights"><?php echo e($defaultStayLength); ?></span>
                </div>
                <div class="summary-row">
                    <span>Rate Plan:</span>
                    <span id="summary_rate_plan"><?php echo e($booking->rate->duration_type); ?></span>
                </div>
        ...
        <div class="form-actions">
            ...
            <div style="margin-left: auto;">
                <a href="<?php echo e(route('bookings.show', $booking->booking_id)); ?>" class="btn-secondary-custom">
...
<script>
let currentStep = 1;
const totalSteps = <?php echo e($booking->status === 'Active' ? 2 : 3); ?>;
const currentRoomId = <?php echo e($booking->room_id); ?>;
const isCheckedIn = <?php echo e($booking->status === 'Active' ? 'true' : 'false'); ?>;

const ratesByDuration = <?php echo json_encode($ratesByDuration->mapWithKeys(function($rate) {
...
const monthlySecurityDeposit = <?php echo e(\App\Http\Controllers\BookingController::MONTHLY_SECURITY_DEPOSIT); ?>;
...
function updateSummary() {
    ...
    document.getElementById('summary_room').textContent = roomCard ? roomCard.querySelector('.room-number').textContent : '<?php echo e($booking->room->room_num); ?>';
...
function loadRooms() {
    ...
    fetch(`<?php echo e(route('bookings.check-availability')); ?>?checkin_date=${checkin}&checkout_date=${checkout}&exclude_booking_id=<?php echo e($booking->booking_id); ?>`)
                ...
                if (!currentRoomInAvailable) {
                    ...
                    html = `
                        <div class="room-card ${isCurrentSelected ? 'selected' : ''}"
                            ...
                            <div class="room-number"><?php echo e($booking->room->room_num); ?></div>
                            <div class="room-floor">Floor <?php echo e($booking->room->floor); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hmmth\sanasa_dormitory\resources\views/contents/bookings-edit.blade.php ENDPATH**/ ?>