<?php $__env->startSection('title', 'Electric Readings'); ?>
...
<div class="container-fluid">
    ...
    <div class="readings-filters">
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem; margin-bottom: 1rem; padding-bottom: 1rem; border-bottom: 1px solid #e2e8f0;">
            ...
            <form method="POST" action="<?php echo e(route('electric-readings.rate')); ?>" id="rateForm" style="display:flex;align-items:center;gap:0.5rem;">
                <?php echo csrf_field(); ?>
                <label for="kwh_price" style="margin:0;font-weight:600;color:#2d3748;">Price/ kWh (₱):</label>
                <input id="kwh_price" type="number" name="electricity_rate_per_kwh" step="0.01" min="0" placeholder="Enter price per kWh" value="<?php echo e($electricityRate ?? ''); ?>" style="width:120px;padding:0.4rem;border:1px solid #d0d7e2;border-radius:6px;" required>
        ...
        <div class="filter-group">
            ...
            <?php $__currentLoopData = $floors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $floor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button type="button" class="filter-btn" data-filter="floor" data-value="<?php echo e($floor); ?>">Floor <?php echo e($floor); ?></button>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
    ...
    <div class="readings-table-container">
        <form method="POST" action="<?php echo e(route('electric-readings.store')); ?>" id="readingsForm">
            <?php echo csrf_field(); ?>
            <table class="readings-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $roomsWithReadings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $room = $item['room'];
                            $latestReading = $item['latestReading'];
                        ?>
                        <tr class="reading-row" data-floor="<?php echo e($room->floor); ?>">
                            <td>
                                <?php if($room->activeBooking): ?>
                                    <a href="<?php echo e(route('bookings.show', $room->activeBooking->booking_id)); ?>"
                                ...
                                <?php else: ?>
                                    <span class="room-number">Room <?php echo e($room->room_num); ?></span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if($latestReading): ?>
                                    <span class="last-reading">
                                        <span class="last-reading-value"><?php echo e(number_format($latestReading->meter_value_kwh, 2)); ?> kWh</span>
                                        <br>
                                        <small>on <?php echo e($latestReading->reading_date->format('M d, Y')); ?></small>
                                    </span>
                                <?php else: ?>
                            ...
                            <td>
                                <input type="number"
                                       ...
                                       name="readings[<?php echo e($room->room_id); ?>][meter_value_kwh]"
                                       data-last-reading="<?php echo e($latestReading ? $latestReading->meter_value_kwh : 0); ?>"
                                       step="0.01"
                                       min="0"
                                       placeholder="e.g. 1300.00">
                                <input type="hidden" name="readings[<?php echo e($room->room_id); ?>][room_id]" value="<?php echo e($room->room_id); ?>">
                            ...
                            <td>
                                <input type="date"
                                       class="date-input"
                                       name="readings[<?php echo e($room->room_id); ?>][reading_date]"
...
function saveRow(button) {
    ...
    const doSave = () => {
        ...
        fetch('<?php echo e(route("electric-readings.store")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
                'X-Requested-With': 'XMLHttpRequest'
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hmmth\sanasa_dormitory\resources\views/contents/electric-readings.blade.php ENDPATH**/ ?>