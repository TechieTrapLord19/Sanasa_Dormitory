...
<div class="bookings-header d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?php echo e(route('bookings.create')); ?>" class="create-booking-btn">
...
<div class="bookings-tabs">
    <!-- Search -->
    <div class="mb-3">
        <form method="GET" action="<?php echo e(route('bookings.index')); ?>" class="d-flex align-items-center gap-2">
    ...
    <div class="tab-buttons">
        ...
        <form method="GET" action="<?php echo e(route('bookings.index')); ?>" class="d-inline-block" style="display:inline-block;">
            <input type="hidden" name="status" value="All">
            <input type="hidden" name="search" value="<?php echo e(request('search')); ?>">
            <button type="submit" class="filter-btn <?php echo e(($statusFilter ?? 'All') === 'All' ? 'active' : ''); ?>">
                All (<?php echo e($statusCounts['All'] ?? 0); ?>)
            </button>
        </form>
        ...
        <form method="GET" action="<?php echo e(route('bookings.index')); ?>" class="d-inline-block" style="display:inline-block;">
            ...
            <input type="hidden" name="search" value="<?php echo e(request('search')); ?>">
            <button type="submit" class="filter-btn <?php echo e(($statusFilter ?? '') === 'Pending Payment' ? 'active' : ''); ?>">
                Pending (<?php echo e($statusCounts['Pending Payment'] ?? 0); ?>)
            </button>
        </form>
        ...
        <form method="GET" action="<?php echo e(route('bookings.index')); ?>" class="d-inline-block" style="display:inline-block;">
            ...
            <input type="hidden" name="search" value="<?php echo e(request('search')); ?>">
            <button type="submit" class="filter-btn <?php echo e(($statusFilter ?? '') === 'Partial Payment' ? 'active' : ''); ?>">
                Partial (<?php echo e($statusCounts['Partial Payment'] ?? 0); ?>)
            </button>
        </form>
        ...
        <form method="GET" action="<?php echo e(route('bookings.index')); ?>" class="d-inline-block" style="display:inline-block;">
            ...
            <input type="hidden" name="search" value="<?php echo e(request('search')); ?>">
            <button type="submit" class="filter-btn <?php echo e(($statusFilter ?? '') === 'Paid Payment' ? 'active' : ''); ?>">
                Paid (<?php echo e($statusCounts['Paid Payment'] ?? 0); ?>)
            </button>
        </form>
        ...
        <form method="GET" action="<?php echo e(route('bookings.index')); ?>" class="d-inline-block" style="display:inline-block;">
            ...
            <input type="hidden" name="search" value="<?php echo e(request('search')); ?>">
            <button type="submit" class="filter-btn <?php echo e(($statusFilter ?? '') === 'Active' ? 'active' : ''); ?>">
        ...
        <form method="GET" action="<?php echo e(route('bookings.index')); ?>" class="d-inline-block" style="display:inline-block;">
            ...
            <input type="hidden" name="search" value="<?php echo e(request('search')); ?>">
            <button type="submit" class="filter-btn <?php echo e(($statusFilter ?? '') === 'Completed' ? 'active' : ''); ?>">
                Completed (<?php echo e($statusCounts['Completed'] ?? 0); ?>)
            </button>
        </form>
        ...
        <form method="GET" action="<?php echo e(route('bookings.index')); ?>" class="d-inline-block" style="display:inline-block;">
            ...
            <input type="hidden" name="search" value="<?php echo e(request('search')); ?>">
            <button type="submit" class="filter-btn <?php echo e(($statusFilter ?? '') === 'Canceled' ? 'active' : ''); ?>">
                Canceled (<?php echo e($statusCounts['Canceled'] ?? 0); ?>)
            </button>
        </form>
    </div>
</div>
...
<div class="bookings-table-container">
    <table class="bookings-table">
        <thead>
            <tr>
                <th>Tenant(s)</th>
                <th class="sortable <?php echo e($sortBy === 'room_num' ? 'active' : ''); ?>" data-sort-column="room_num">
                    Room Number
                    <?php if($sortBy === 'room_num'): ?>
                        <i class="bi bi-<?php echo e($sortDir === 'asc' ? 'sort-up' : 'sort-down'); ?> sort-icon"></i>
                    <?php else: ?>
                        <i class="bi bi-arrow-down-up sort-icon"></i>
                    <?php endif; ?>
                </th>
                <th class="sortable <?php echo e($sortBy === 'check_in_date' ? 'active' : ''); ?>" data-sort-column="check_in_date">
                    Check-in Date
                    <?php if($sortBy === 'check_in_date'): ?>
                        <i class="bi bi-<?php echo e($sortDir === 'asc' ? 'sort-up' : 'sort-down'); ?> sort-icon"></i>
                    <?php else: ?>
                        <i class="bi bi-arrow-down-up sort-icon"></i>
                    <?php endif; ?>
                </th>
                <th class="sortable <?php echo e($sortBy === 'check_out_date' ? 'active' : ''); ?>" data-sort-column="check_out_date">
                    Check-out Date
                    <?php if($sortBy === 'check_out_date'): ?>
                        <i class="bi bi-<?php echo e($sortDir === 'asc' ? 'sort-up' : 'sort-down'); ?> sort-icon"></i>
                    <?php else: ?>
                        <i class="bi bi-arrow-down-up sort-icon"></i>
                    <?php endif; ?>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="booking-row-clickable" data-booking-id="<?php echo e($booking->booking_id); ?>" style="cursor: pointer;">
                    <td>
                        <strong><?php echo $booking->tenant_summary; ?></strong>
                    </td>
                    <td>
                        <?php echo e($booking->room->room_num); ?>

                    </td>
                    <td>
                        <?php if($booking->checked_in_at): ?>
                            <?php echo e($booking->checked_in_at->format('M d, Y')); ?>
                    ...
                    <td>
                        <?php if($booking->checked_out_at): ?>
                            <?php echo e($booking->checked_out_at->format('M d, Y')); ?>
                    ...
                    <td>
                        <?php echo e($booking->rate->duration_type); ?> - ₱<?php echo e(number_format($booking->rate->base_price, 2)); ?>
                    ...
                    <td>
                        ...
                        ?>
                        <span class="status-badge <?php echo e(str_replace(' ', '-', $status)); ?>">
                            <?php echo e($status); ?>
                    ...
                    <td class="action-column" onclick="event.stopPropagation();">
                        <div class="action-buttons">
                            <a href="<?php echo e(route('bookings.show', $booking->booking_id)); ?>" class="btn-view">
                                <i class="bi bi-eye"></i> View
                            </a>
                            <?php if($booking->effective_status !== 'Canceled' && $booking->effective_status !== 'Completed'): ?>
                                <button type="button" class="btn-cancel" data-bs-toggle="modal" data-bs-target="#cancelBookingModal<?php echo e($booking->booking_id); ?>">
    ...
    <div class="pagination-wrapper">
        ...
        <div class="pagination-center">
            <p class="small text-muted mb-0">
                Showing
                <span class="fw-semibold"><?php echo e($bookings->firstItem() ?? 0); ?></span>
                to
                <span class="fw-semibold"><?php echo e($bookings->lastItem() ?? 0); ?></span>
                of
                <span class="fw-semibold"><?php echo e($bookings->total()); ?></span>
                results
            </p>
        </div>
        <div class="pagination-right">
            <?php echo e($bookings->appends(['status' => $statusFilter, 'search' => $searchTerm, 'per_page' => $perPage, 'sort_by' => $sortBy, 'sort_dir' => $sortDir])->links()); ?>
...
<?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($booking->effective_status !== 'Canceled' && $booking->effective_status !== 'Completed'): ?>
    <div class="modal fade" id="cancelBookingModal<?php echo e($booking->booking_id); ?>" tabindex="-1" aria-labelledby="cancelBookingModalLabel<?php echo e($booking->booking_id); ?>" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="cancelBookingModalLabel<?php echo e($booking->booking_id); ?>">Cancel Booking</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="<?php echo e(route('bookings.destroy', $booking->booking_id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="cancellation_reason<?php echo e($booking->booking_id); ?>" class="form-label">Cancellation Reason <span class="text-danger">*</span></label>
                            <textarea class="form-control"
                                      id="cancellation_reason<?php echo e($booking->booking_id); ?>"
    ...
    bookingRows.forEach(row => {
        row.addEventListener('click', function(e) {
            ...
            if (bookingId) {
                ...
                window.location.href = '<?php echo e(route("invoices")); ?>?booking_id=' + bookingId;
            }
        });
    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hmmth\sanasa_dormitory\resources\views/contents/bookings.blade.php ENDPATH**/ ?>