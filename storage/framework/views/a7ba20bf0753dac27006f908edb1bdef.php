...
<div class="container-fluid">
    ...
    <div class="logs-filters">
        <form method="GET" action="<?php echo e(route('maintenance-logs')); ?>" id="filterForm" class="d-flex flex-wrap align-items-end gap-3">
            <div class="filter-group">
                <label class="filter-label">Status:</label>
                <select name="status" class="filter-select" onchange="this.form.submit()">
                    <option value="">All Statuses</option>
                    <option value="Pending" <?php echo e($selectedStatus == 'Pending' ? 'selected' : ''); ?>>Pending</option>
                    <option value="In Progress" <?php echo e($selectedStatus == 'In Progress' ? 'selected' : ''); ?>>In Progress</option>
                    <option value="Completed" <?php echo e($selectedStatus == 'Completed' ? 'selected' : ''); ?>>Completed</option>
                    <option value="Cancelled" <?php echo e($selectedStatus == 'Cancelled' ? 'selected' : ''); ?>>Cancelled</option>
                </select>
            </div>
            ...
            <div class="filter-group">
                ...
                <select name="date_filter" id="dateFilterSelect" class="filter-select" onchange="handleDateFilterChange(this)">
                    ...
                    <option value="custom" <?php echo e($dateFilter == 'custom' ? 'selected' : ''); ?>>Custom Range</option>
                </select>
            </div>

            <div class="filter-group" id="customDateInputs" style="display: <?php echo e($dateFilter == 'custom' ? 'flex' : 'none'); ?>; gap: 0.5rem;">
                <input type="date" name="date_from" class="filter-input" value="<?php echo e($dateFrom); ?>" onchange="this.form.submit()">
                <span style="color: #64748b;">to</span>
                <input type="date" name="date_to" class="filter-input" value="<?php echo e($dateTo); ?>" onchange="this.form.submit()">
            </div>

            <div class="filter-group">
                <a href="<?php echo e(route('maintenance-logs')); ?>?date_filter=this_month" class="filter-btn filter-btn-clear" style="text-decoration: none; display: inline-block;">Clear</a>
            </div>
        </form>
    </div>
    ...
    <div class="logs-table-container">
        <?php if($logs->count() > 0): ?>
            <table class="logs-table">
                <thead>
                    <tr>
                        <th class="sortable <?php echo e($sortBy === 'date_reported' ? 'active' : ''); ?>" onclick="sortTable('date_reported')">
                            Date Reported
                            <?php if($sortBy === 'date_reported'): ?>
                                <i class="bi bi-<?php echo e($sortDir === 'asc' ? 'sort-up' : 'sort-down'); ?> sort-icon"></i>
                            <?php else: ?>
                                <i class="bi bi-arrow-down-up sort-icon"></i>
                            <?php endif; ?>
                        </th>
                        <th class="sortable <?php echo e($sortBy === 'asset_id' ? 'active' : ''); ?>" onclick="sortTable('asset_id')">
                            Asset / Location
                            <?php if($sortBy === 'asset_id'): ?>
                                <i class="bi bi-<?php echo e($sortDir === 'asc' ? 'sort-up' : 'sort-down'); ?> sort-icon"></i>
                            <?php else: ?>
                                <i class="bi bi-arrow-down-up sort-icon"></i>
                            <?php endif; ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <div><?php echo e($log->date_reported->format('M d, Y')); ?></div>
                            </td>
                            <td>
                                <strong><?php echo e($log->asset_location); ?></strong>
                            </td>
                            <td>
                                <div class="description-text"><?php echo e($log->description); ?></div>
                            </td>
                            <td>
                                <strong><?php echo e($log->reporter_name); ?></strong>
                            </td>
                            <td>
                                <?php
                                    $statusClass = str_replace(' ', '-', $log->status);
                                ?>
                                <span class="status-badge <?php echo e($statusClass); ?>"><?php echo e($log->status); ?></span>
                            </td>
                            <td>
                                <button type="button"
                                        class="btn-update-status"
                                        data-bs-toggle="modal"
                                        data-bs-target="#updateStatusModal<?php echo e($log->log_id); ?>">
            ...
            <div class="pagination-wrapper">
                <div class="pagination-left">
                    <form method="GET" action="<?php echo e(route('maintenance-logs')); ?>" class="d-flex align-items-center gap-2">
                        ...
                        <?php endif; ?>
                        <input type="hidden" name="asset_id" value="<?php echo e($selectedAssetId); ?>">
                ...
                <div class="pagination-right">
                    <?php echo e($logs->appends(['status' => $selectedStatus, 'date_filter' => $dateFilter, 'date_from' => $dateFrom, 'date_to' => $dateTo, 'asset_id' => $selectedAssetId, 'per_page' => $perPage, 'sort_by' => $sortBy, 'sort_dir' => $sortDir])->links()); ?>
            ...
            <form action="<?php echo e(route('maintenance-logs.store')); ?>" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select <?php $__errorArgs = ['asset_id'];
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($asset->asset_id); ?>" <?php echo e(old('asset_id') == $asset->asset_id ? 'selected' : ''); ?>>
                                    <?php echo e($asset->name); ?> - <?php echo e($asset->location); ?>
...
<?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="updateStatusModal<?php echo e($log->log_id); ?>" tabindex="-1" aria-labelledby="updateStatusModalLabel<?php echo e($log->log_id); ?>" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateStatusModalLabel<?php echo e($log->log_id); ?>">Update Status</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="<?php echo e(route('maintenance-logs.update', $log->log_id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text"
                               class="form-control"
                               value="<?php echo e($log->status); ?>"
                               readonly
                               style="background-color: #f8fafc;">
                    </div>

                    <div class="mb-3">
                        <label for="status<?php echo e($log->log_id); ?>" class="form-label">New Status <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                id="status<?php echo e($log->log_id); ?>"
                                name="status"
                                required>
                            <option value="Pending" <?php echo e(old('status', $log->status) === 'Pending' ? 'selected' : ''); ?>>Pending</option>
                            <option value="In Progress" <?php echo e(old('status', $log->status) === 'In Progress' ? 'selected' : ''); ?>>In Progress</option>
                            <option value="Completed" <?php echo e(old('status', $log->status) === 'Completed' ? 'selected' : ''); ?>>Completed</option>
                            <option value="Cancelled" <?php echo e(old('status', $log->status) === 'Cancelled' ? 'selected' : ''); ?>>Cancelled</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        <label for="notes<?php echo e($log->log_id); ?>" class="form-label">Notes</label>
...
unset($__errorArgs, $__bag); ?>"
                                  id="notes<?php echo e($log->log_id); ?>"
                                  name="notes"
                                  rows="3"><?php echo e(old('notes', $log->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        <label for="date_completed<?php echo e($log->log_id); ?>" class="form-label">Date Completed</label>
                        <input type="date"
                               class="form-control <?php $__errorArgs = ['date_completed'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                               id="date_completed<?php echo e($log->log_id); ?>"
                               name="date_completed"
                               value="<?php echo e(old('date_completed', $log->date_completed ? $log->date_completed->format('Y-m-d') : '')); ?>">
                        <small class="text-muted">Auto-fills when status is set to "Completed"</small>
                        <?php $__errorArgs = ['date_completed'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hmmth\sanasa_dormitory\resources\views/contents/maintenance-logs.blade.php ENDPATH**/ ?>