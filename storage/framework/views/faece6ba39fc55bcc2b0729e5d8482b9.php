        ...
        <div class="flex-grow-1">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="profile-info-value"><?php echo e($user->full_name); ?></div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="profile-info-value">
                        <span class="badge <?php echo e(strtolower($user->role) === 'owner' ? 'bg-primary' : 'bg-info'); ?>">
                ...
                <div class="col-md-6">
                    ...
                    <div class="profile-info-value">
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('two-factor.setup')); ?>" class="ms-2 small">Enable now</a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="profile-info-value">
                        <span class="badge <?php echo e(strtolower($user->status) === 'active' ? 'bg-success' : 'bg-secondary'); ?>">
                ...
                <div class="col-md-6">
                    ...
                    <div class="profile-info-value"><?php echo e($user->created_at->format('F j, Y')); ?></div>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hmmth\sanasa_dormitory\resources\views/contents/account.blade.php ENDPATH**/ ?>