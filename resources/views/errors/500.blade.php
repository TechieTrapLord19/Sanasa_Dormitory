...
<head>
    ...
    <title>{{ config('app.name', 'Sanasa Dormitory') }} - 500 Server Error</title>
    ...
    <div class="min-vh-100 d-flex">
        ...
        <div class="col-6 d-flex align-items-center justify-content-center p-4">
            <div class="error-card">
                ...
                <p class="error-message">Something went wrong on our end. Please try again later or contact the system administrator.</p>
